...
class LibRadar(object):
    ...
    def __init__(self, apk_path):
        ...
        """
        # apk_path = "G:\\github\\LibRadar-master\\LibRadar-master\\LibRadar\\qq.apk"
    ...
    def extract_dex(self):
        ...
        for dex_class_def_obj in self.dex.dexClassDefList:
            ...
            if IGNORE_ZERO_API_FILES and weight == 0:
                continue
            aa=self.tree.insert(package_name=class_name, weight=weight, sha256=raw_sha256,
